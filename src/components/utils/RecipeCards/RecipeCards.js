...
const RecipeCards=(props)=> {
    const {image, width, catagory, dishname, discription, servings, servings_digit_size, servings_text_size} = props;
    return (
        <div>
           <div>
               <div className="outer_box" style={{width:width}}>
                   <div style={{position: 'relative'}}>
                        <img src="/images/go-btn.png" class="_arrow" />
